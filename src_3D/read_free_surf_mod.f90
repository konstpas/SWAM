module read_free_surface_module
   ...
   contains
     ...
     ! read from file
     ! -----------------------------------------------------------------
     subroutine get_free_surface(surf_ind, surf_xlo, surf_dx, melt_top, melt_pos, surf_pos)
        ...
        call get_mesh_dimensions (sw_free_surface_file, len(sw_free_surface_file), points(1:2))
     ...
     ! -----------------------------------------------------------------
     subroutine get_mesh_dimensions(input_filename, length, dims)
 ...
 end module read_free_surface_module
