...
!       amrex_particlecontainer_destroy
  ...
  public :: melt_pos, surf_pos, melt_vel, height_flux  ! SW transients of the solution
  ...
  real(rt), allocatable :: surf_pos(:,:), melt_pos(:,:), melt_vel(:,:,:), height_flux(:,:,:) ! Init in my_amr_mod 
