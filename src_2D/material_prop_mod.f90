...
contains 
  ...
  subroutine get_conductivity(temp,ktherm)
    ...
    use material_properties_iridium_module, only :  get_conductivity_iridium
    use material_properties_niobium_module,  only : get_conductivity_niobium
  ...
  subroutine get_mass_density(temp,rho)
    ...
    use read_input_module, only : material_name    
    use material_properties_tungsten_module, only : get_mass_density_tungsten
    use material_properties_test_melting_one_phase_module, only : get_mass_density_test_melting_one_phase
    use material_properties_test_melting_two_phase_module, only : get_mass_density_test_melting_two_phase    
    use material_properties_test_evaporation_module, only : get_mass_density_test_evaporation                                                      
    use material_properties_beryllium_module, only : get_mass_density_beryllium
    use material_properties_iridium_module, only :  get_mass_density_iridium
    use material_properties_niobium_module,  only : get_mass_density_niobium
   ...
   subroutine get_heat_capacity(temp,Cp)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_heat_capacity_tungsten
     use material_properties_test_melting_one_phase_module, only : get_heat_capacity_test_melting_one_phase
     use material_properties_test_melting_two_phase_module, only : get_heat_capacity_test_melting_two_phase    
     use material_properties_test_evaporation_module, only : get_heat_capacity_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_heat_capacity_beryllium
   ...
   subroutine get_atomic_mass(m_A)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_atomic_mass_tungsten
     use material_properties_test_melting_one_phase_module, only : get_atomic_mass_test_melting_one_phase
     use material_properties_test_melting_two_phase_module, only : get_atomic_mass_test_melting_two_phase    
     use material_properties_test_evaporation_module, only : get_atomic_mass_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_atomic_mass_beryllium
     use material_properties_iridium_module, only :  get_atomic_mass_iridium
     use material_properties_niobium_module,  only : get_atomic_mass_niobium
   ...
   subroutine get_melting_point()
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_melting_point_tungsten
     use material_properties_test_melting_one_phase_module, only : get_melting_point_test_melting_one_phase
     use material_properties_test_melting_two_phase_module, only : get_melting_point_test_melting_two_phase    
     use material_properties_test_evaporation_module, only : get_melting_point_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_melting_point_beryllium
     use material_properties_iridium_module, only :  get_melting_point_iridium
     use material_properties_niobium_module,  only : get_melting_point_niobium
   ...
   subroutine get_electrical_resistivity(temp, rho_e)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_electrical_resistivity_tungsten
     use material_properties_test_evaporation_module, only : get_electrical_resistivity_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_electrical_resistivity_beryllium
     use material_properties_iridium_module, only :  get_electrical_resistivity_iridium
     use material_properties_niobium_module,  only : get_electrical_resistivity_niobium
   ...
   subroutine get_surface_tension(temp, sigma)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_surface_tension_tungsten
     use material_properties_test_evaporation_module, only : get_surface_tension_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_surface_tension_beryllium
     use material_properties_iridium_module, only :  get_surface_tension_iridium
     use material_properties_niobium_module,  only : get_surface_tension_niobium
   ...
   subroutine get_viscosity(temp, mu)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_viscosity_tungsten
     use material_properties_test_evaporation_module, only : get_viscosity_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_viscosity_beryllium
     use material_properties_iridium_module, only :  get_viscosity_iridium
     use material_properties_niobium_module,  only : get_viscosity_niobium
   ...
   subroutine get_vapor_pressure(temp, pv)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_vapor_pressure_tungsten
     use material_properties_test_evaporation_module, only : get_vapor_pressure_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_vapor_pressure_beryllium
     use material_properties_iridium_module, only :  get_vapor_pressure_iridium
     use material_properties_niobium_module,  only : get_vapor_pressure_niobium
   ...
   subroutine get_enthalpy_of_vaporization(temp, enth_vap)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_enthalpy_of_vaporization_tungsten
     use material_properties_test_evaporation_module, only : get_enthalpy_of_vaporization_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_enthalpy_of_vaporization_beryllium
     use material_properties_iridium_module, only :  get_enthalpy_of_vaporization_iridium
     use material_properties_niobium_module,  only : get_enthalpy_of_vaporization_niobium
   ...
   subroutine get_work_function(wf)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_work_function_tungsten
     use material_properties_test_evaporation_module, only : get_work_function_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_work_function_beryllium
     use material_properties_iridium_module, only :  get_work_function_iridium
     use material_properties_niobium_module,  only : get_work_function_niobium
   ...
   subroutine get_richardson_constant(Aeff)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_richardson_constant_tungsten
     use material_properties_test_evaporation_module, only : get_richardson_constant_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_richardson_constant_beryllium
     use material_properties_iridium_module, only :  get_richardson_constant_iridium
     use material_properties_niobium_module,  only : get_richardson_constant_niobium
   ...
   subroutine get_emissivity(temp, eps_t)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_emissivity_tungsten
     use material_properties_test_evaporation_module, only : get_emissivity_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_emissivity_beryllium
     use material_properties_iridium_module, only :  get_emissivity_iridium
     use material_properties_niobium_module,  only : get_emissivity_niobium
   ...
   subroutine get_thermelectric_power(temp, S)
     ...
     use read_input_module, only : material_name    
     use material_properties_tungsten_module, only : get_thermelectric_power_tungsten
     use material_properties_test_evaporation_module, only : get_thermelectric_power_test_evaporation                                                      
     use material_properties_beryllium_module, only : get_thermelectric_power_beryllium
     use material_properties_iridium_module, only :  get_thermelectric_power_iridium
     use material_properties_niobium_module,  only : get_thermelectric_power_niobium
  ...
  subroutine get_temp(lo, hi, &
    ...
    use read_input_module, only : material_nPoints
    ...
    if (direct) then
       ...
       do j = lo(2),hi(2)
          do i = lo(1),hi(1)
             ...
             call bisection(enth_table, material_nPoints+1, ui(i,j), idx)
       ...
       do j = lo(2),hi(2)             
          do i = lo(1),hi(1)
             ...
             call bisection(temp_table, material_nPoints+1, temp(i,j), idx)
